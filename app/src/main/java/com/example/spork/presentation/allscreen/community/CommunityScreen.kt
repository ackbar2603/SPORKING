package com.example.spork.presentation.allscreen.community
...
fun communityScreen(navController: NavController){
    ...
    Scaffold (
        topBar = { TopBar(backButton = {null}, value = stringResource(id = R.string.komunitas)) },
        ...
        Surface (
            ...
            Column (
                ...
                ButtonComponent(value = stringResource(id = R.string.mulai_komunitas), onTaskClick = {navController.navigate(Screen.NewCommunityScreen.route)})
            }
        }
    }
}
